# Terms of Service - Impostor Game

**Last Updated:** January 23, 2026

## 1. Acceptance of Terms

By downloading, installing, and using Impostor Game ("App", "Service", "we", "us", or "our"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.
...
- Not interfere with or disrupt the integrity or performance of the App
- Not attempt to scrape, crawl, or extract data from the App
- Not use automated tools or bots to access the App
- Not engage in any form of harassment or abuse
...
- Software code
- Graphics and design
- Word packs and word lists
- User interface elements
- Documentation

...is owned by us or our licensors and is protected by copyright, trademark, and other intellectual property laws.

You may not use any content from the App without our prior written permission.

## 5. User-Generated Content

The App does not allow users to create, upload, or share content. All gameplay is local to your device.
...
You agree to indemnify, defend, and hold harmless us and our officers, directors, employees, and agents from any claims, damages, losses, or expenses (including attorney's fees) arising from:
...
We may terminate or suspend your access to the App at any time, without notice or liability, for any reason, including if you violate these Terms.
...
- You have the right to opt-out of data sales (we do not sell data)
- You have the right to non-discrimination for exercising your rights

### United States
- These Terms are governed by applicable U.S. federal law and state law
- You agree to resolve disputes through binding arbitration

## 16. Age Restrictions

The App is intended for users aged 13 and older. If you are under 13, you may only use the App with parental consent and supervision.

## 17. Warranty Disclaimer for Specific Features

### Offline Functionality
- We do not warrant that offline functionality will work in all circumstances
- Offline functionality depends on successful prior download of word packs
- Cache may be cleared by device updates or storage management

### Rate Limiting
- We implement rate limiting to prevent abuse
- Legitimate users may experience rate limiting if they exceed 30 requests per minute
- Rate limiting is subject to change without notice

## 18. Third-Party Services

The App may use third-party services (e.g., Firebase for analytics). These services are subject to their own terms and privacy policies. We are not responsible for third-party services.
...
If any provision of these Terms is found to be unenforceable, the remaining provisions shall continue in effect. Our failure to enforce any right or provision shall not constitute a waiver of that right or provision.
